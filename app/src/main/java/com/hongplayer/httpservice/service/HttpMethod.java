...
import com.hongplayer.HApplication;
import com.hongplayer.util.NetUtil;
...
public class HttpMethod {
    ...
    public static OkHttpClient genericClient() {
        ...
        //设置缓存路径
        File httpCacheDirectory = new File(HApplication.getInstance().getExternalCacheDir().getAbsolutePath(), "responses");
        //设置缓存 10M
        ...
        OkHttpClient httpClient = new OkHttpClient.Builder()
                .addInterceptor(new Interceptor() {
                    ...
                    public Response intercept(Chain chain) throws IOException {
                        ...
                        if (!NetUtil.getNetworkIsConnected(HApplication.getInstance())) {
