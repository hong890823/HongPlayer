...
public class RadioAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public RadioAdapter(Context context, List<RadioLiveChannelBean> datas) {
    ...
    {
        void onItemClick(RadioLiveChannelBean liveChannelBean, int position);
    }

    public interface OnItemLongClickListener
    {
        void onLongItemClick(RadioLiveChannelBean liveChannelBean, int position);
    }
}
